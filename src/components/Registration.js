                        ...
                        <div className="col">
                            <ul className='list-group'>
                                <li className="list-group-item">
                                    ...
                                    <p className="font-weight-bold">username : {registeredUser.username}</p>
                                    <p className="font-weight-bold">email : {registeredUser.email}</p>
                                    <p className="font-weight-bold">password : {registeredUser.password}</p>
                                </li>
                            </ul>
                        </div>
                    </div> : null
